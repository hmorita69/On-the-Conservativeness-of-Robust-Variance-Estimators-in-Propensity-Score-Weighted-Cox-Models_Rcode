...
# ============================================================
# 10シナリオ × ATE/ATT/ATO の真値 log_beta を保存するコード
# 変えるもの：
# 1. 治療モデルの L2 係数
# 2. 治療モデルの L3 係数
# 3. アウトカム時間モデルの L2 係数
...
#   
#   # 治療割り付けモデルの L2, L3 係数
#   trt_L2 = c(0.1, 0.1, 0.1, 0.2, 0.2, 0.2, 0.3, 0.3, 0.4, 0.4),
#   trt_L3 = c(0.1, 0.2, 0.3, 0.1, 0.2, 0.3, 0.1, 0.2, 0.3, 0.4),
#   
#   # アウトカム時間モデルの L2, L3 係数
#   # Ttime の式では -log(out_L2)*L2, -log(out_L3)*L3 として使う
#   out_L2 = c(0.4, 0.4, 0.6, 0.4, 0.6, 0.8, 0.4, 0.6, 0.8, 1.0),
#   out_L3 = c(0.4, 0.6, 0.4, 0.8, 0.6, 0.4, 1.0, 0.8, 0.6, 0.4),
#   
#   # 打ち切り率
#   rateC = c(
#     0.0001, 0.0001, 0.0002, 0.0002, 0.0003,
#     0.0003, 0.0005, 0.0005, 0.0010, 0.0010
#   )
# )
...
calc_truth_one <- function(scenario,
  ...
  if (nrow(sc) != 1) {
    stop("scenario_setting に該当する scenario が1行だけ存在する必要があります。")
  }
